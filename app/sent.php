...
//check connection
  ...
  $sql = "INSERT INTO appform (username, email, phone, Gender, Ethnicity, Institution, Course, applicationletter, uploadedID, letterFromInstitute, insurance, goodConduct ) VALUES ('$username', '$email', '$phone','$gender','$ethnicity', '$institution', '$course', '$aplNameNew', '$uplIDNameNew', '$uplLFINameNew', '$uplINameNew', '$uplGCNameNew')";
